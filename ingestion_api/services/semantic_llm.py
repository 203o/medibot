...
def synthesize_tiered(payload: dict[str, Any]) -> dict[str, Any]:
    ...
    user_prompt = (
        ...
        "- Write direct_answer as a natural answer sentence or short paragraph, not a template heading.\n"
        "- Write supporting_explanation as follow-on prose that explains the answer in plain language.\n"
        "- Prefer a detailed response that synthesizes the evidence into a natural explanation for the user.\n"
